...
const Nav = () => {
  ...
  return (
    <header className="flex justify-between items-center p-5 fixed top-0 w-full bg-white shadow-md z-50">
      ...
      {/* Navigation Links */}
      <nav className={`absolute lg:relative lg:top-16 left-0 w-full lg:w-auto bg-white lg:bg-transparent shadow-lg lg:shadow-none transition-all ${show ? 'block' : 'hidden'} lg:flex`}>
